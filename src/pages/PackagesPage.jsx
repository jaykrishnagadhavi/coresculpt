    ...
    <section className="py-32 px-6 md:px-12 max-w-5xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-400 text-lg max-w-3xl mx-auto mb-4">
          CoreSculpt App brings you a plethora of options with Circuit training, Bodyweight strength, Yoga, Pilates, Callisthenics, Resistance & strength training along with nutrition and habit coaching services into one comprehensive platform. 🤸‍♀️✨
        </p>
          ...
          {[
            ...
            <div key={idx} className="w-full h-full">
              ...
              >
                ...
                <span className="text-xs text-brand-primary font-bold">Inquire via WhatsApp 💬</span>
              </a>
            </div>
          ))}
        </div>
