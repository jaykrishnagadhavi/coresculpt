        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl mx-auto md:mx-0 leading-relaxed">
              Get fit with uniquely crafted sessions of Bodyweight training, Calisthenics, Pilates, Resistance Training, Cardio, and Yoga. All designed to Sculpt your Core like never before! 🧘‍♀️⚡
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center md:justify-start gap-4">
              ...
              >
                ...
                <span className="text-brand-primary text-sm font-black">App Store 🍏</span>
              </a>
              <a 
                href={playStoreUrl} 
                target="_blank" 
              ...
              >
                ...
                <span className="text-brand-accent text-sm font-black">Google Play 👾</span>
              </a>
            </div>
          </div>
            ...
            <div className="w-full">
              <div className="relative w-full aspect-[4/5] md:aspect-square rounded-[15px] overflow-hidden shadow-[0_20px_50px_#00000080] border border-brand-border bg-slate-900 group">
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <span className="bg-brand-primary/20 border border-brand-primary text-brand-primary text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full backdrop-blur-sm">
                    KeepWell Mantras London 🇬🇧
                  </span>
                </div>
              </div>
            </div>
