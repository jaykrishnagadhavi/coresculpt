...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050508] border-t border-brand-border pt-16 pb-8">
          ...
          <div className="md:col-span-5">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-brand-primary hover:text-slate-900 transition-colors"
